<!-- eslint-disable -->
<!--
 * MediaSFU Broadcast Component Configuration and Usage Guide
 *
 * The following code and comments will guide you through:
 * 1. Configuring the MediaSFU Broadcast component with different server and credential setups.
...
// MediaSFU Broadcast view component
...
const returnUI = true // Set to false to build a fully custom UI from scratch

const cardOverrides = createCardOverrides({
  accent: '#f97316',
  glow: 'rgba(249, 115, 22, 0.35)',
  audioBackground: 'rgba(254, 215, 170, 0.25)',
  miniBackground: 'rgba(251, 191, 36, 0.18)',
  miniTextColor: '#7c2d12',
})
