import {
  ...
  fhdFrameRate,
  qhdFrameRate,
} from "mediasfu-shared"; // Import the video capture constraints from the shared SDK

import { hParams as host_Params } from "mediasfu-shared";
import type { HParamsType } from "mediasfu-shared";
import { vParams as video_Params } from "mediasfu-shared";
import type { VParamsType } from "mediasfu-shared";
import { screenParams as screen_Params } from "mediasfu-shared";
