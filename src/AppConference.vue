...
const returnUI = true // Toggle to false to build a completely custom experience

const cardOverrides = createCardOverrides({
  accent: '#38bdf8',
  glow: 'rgba(56, 189, 248, 0.35)',
  audioBackground: 'rgba(56, 189, 248, 0.18)',
  miniBackground: 'rgba(14, 165, 233, 0.18)',
  miniTextColor: '#082f49',
})
...
// MediasfuConference, MediasfuBroadcast, MediasfuWebinar, MediasfuChat
//
